...
public class ShotEntity extends Entity {
  ...
  private boolean playerShot; // true if sent from player
   ...
   */
  public ShotEntity(Game g, String r, int newX, int newY, int speed, boolean fromPlayer) {
    super(r, newX, newY);  // calls the constructor in Entity
    game = g;
    dy = speed;
    playerShot = fromPlayer;
  } // constructor
   ...
   */
   public void collidedWith(Entity other) {
     ...
     if (other instanceof AlienEntity && playerShot) {
