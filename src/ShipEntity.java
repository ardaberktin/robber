...
public class ShipEntity extends Entity {
   ...
   */
   public void collidedWith(Entity other) {
     if (other instanceof AlienEntity || other instanceof LaserEntity || 
    		 other instanceof ShotEntity || other instanceof WalkingPoliceEntity ||
    		 other instanceof FlashPolice) {
